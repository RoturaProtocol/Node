var NSV = (function(NSV, $, undefined) {
    ...
    // copied from brs.server and increased size of timeout due to problems with GetTransaction. Maybe not needed but...
