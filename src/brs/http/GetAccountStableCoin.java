...
public final class GetAccountStableCoin extends APIServlet.JsonRequestHandler {
  ...
  GetAccountStableCoin(ParameterService parameterService, AccountService accountService, Blockchain blockchain, Generator generator) {
  ...
  JsonElement processRequest(HttpServletRequest req) throws BurstException {
    ...
    Account account = parameterService.getAccountStableCoin(req);
