...
public class HistoricalMoments {
    ...
    public static HistoricalMoments PRE_POC2 = new HistoricalMoments(1, Props.PRE_POC2_BLOCK_HEIGHT);//The original value is 500000
    ...
    public static HistoricalMoments SIGNUM = new HistoricalMoments(0, Props.SIGNUM_HEIGHT);
    public static HistoricalMoments POC_PLUS = new HistoricalMoments( 2147483647, Props.POC_PLUS_HEIGHT);
